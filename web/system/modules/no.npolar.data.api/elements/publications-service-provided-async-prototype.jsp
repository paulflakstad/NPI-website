...
//cms.include(cms.getTemplate(), cms.getTemplateIncludeElements()[0], false);
...
%>
<script type="text/javascript">
    var provider = '<%= cms.link("/system/modules/no.npolar.data.api/elements/publications-loader-async-prototype.jsp") %>';
...
//cms.include(cms.getTemplate(), cms.getTemplateIncludeElements()[1], false);
%>
