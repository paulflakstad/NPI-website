<%-- 
    Document   : employee-searchbox
    Created on : Dec 20, 2011, 6:13:02 PM
    Author     : flakstad
...
if (!result.isEmpty()) {
    ...
    <script type="text/javascript">
        ...
        document.write('<form id="employeelookup" method="post" action="<%= cms.link(employeeFolder) %>">');
        document.write('<%= cms.labelUnicode("label.np.searchemployee") %>: ');
        document.write('<input type="text" name="employeename" size="20" id="employeename" value="" style="width:50%;" />');
