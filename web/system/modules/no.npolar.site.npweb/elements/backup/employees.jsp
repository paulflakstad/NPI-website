...
if (result.isEmpty()) {
    ...
    out.println("<tr class=\"table-header-row\">" +
                    "<th width=\"40%\">" + cms.label("label.Person.Name") + "</th>" +
                    "<th width=\"60%\">" + cms.label("label.Person.Position") + "</th>" +
                "</tr>");
    while (listItems.hasMoreContent()) {
        ...
        */
        ...
        out.println("<tr>" +
                        "<td><a href=\"" + cms.link(itemPath) + "\">" + itemTitle + "</a></td>" +
                        (!itemDescription.startsWith("/") ? ("<td>" + itemDescription + "</td>") : "") + 
                    "</tr>");
    }
    out.println("</tbody>");
    out.println("</table>");
