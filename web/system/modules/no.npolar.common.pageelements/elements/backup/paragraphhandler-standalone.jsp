...
if (request.getAttribute("paragraphContainer") != null) {
    ...
    if (request.getAttribute("paragraphWrapper") != null) 
        paragraphWrapper = (String[])request.getAttribute("paragraphWrapper");
}
else {
    // Load the content
...
<%
        ...
        try {
            ...
            while (imageContainer.hasMoreContent()) {
                imagePath       = cms.contentshow(imageContainer, "URI");
                imageCaption    = cms.contentshow(imageContainer, "Text");
                imageTitle      = cms.contentshow(imageContainer, "Title").replaceAll(" & ", " &amp; ");
                imageSource     = cms.contentshow(imageContainer, "Source");
                ...
                if (cmso.existsResource(imagePath)) {
                    ...
                    if (imageDimensions[0] > imageSizeChoice) {
                        ...
                        scaledImageTag = "<a href=\"" + imagePath + "\"" + 
                        ...
                        // No downscale needed
                        scaledImageTag = "<img src=\"" + imagePath + "\" />";
                        imageWidth = imageDimensions[0];
                    }
                }
                else {
                    scaledImageTag = "<img src=\"\" alt=\"\" />";
                    throw new ServletException("The referred image linkList does not exist. (Path was '" +
        ...
        try {
            ...
            while (textBoxContainer.hasMoreContent()) {
                tbTitle                 = cms.contentshow(textBoxContainer, "Title").replaceAll(" & ", " &amp; ");
        ...
        out.println(paragraphWrapper[1] + "<!-- .paragraph -->");
