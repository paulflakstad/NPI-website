...
final String FOLDER = "/no/om-oss/formidling/kronikker/arkiv/2010/";// "/no/ansatte/";
//final String FOLDER = "/en/about-us/news/archive/2011/k1/";// "/no/ansatte/";
...
//final String OLD_CAT_FOLDER         = "/sites/np/en/_categories/theme/";
final String OLD_CAT_FOLDER         = "/sites/np/no/_categories/tema/";
final String NEW_CAT_FOLDER         = "/sites/np/no/_categories/theme/";

Map catMap = new HashMap();
catMap.put("antarktis/", "antarctic/");
catMap.put("arktis/", "arctic/");
catMap.put("dyr/", "wildlife/");
catMap.put("ekspedisjon/", "expedition/");
catMap.put("formidling/", "outreach/");
catMap.put("forskning/", "research/");
catMap.put("forvaltning/", "management/");
catMap.put("havis/", "seaice/");
catMap.put("historie/", "history/");
catMap.put("isbre/", "glaciers/");
catMap.put("klima/", "climate/");
catMap.put("marineoko/", "marineeco/");
catMap.put("miljogift/", "pollutants/");
catMap.put("np/", "npi/");
catMap.put("oseanografi/", "oceanography/");

if (!OLD_CAT_FOLDER.equals(NEW_CAT_FOLDER)) {
    catMap.put("biodiv/", "biodiv/");
    catMap.put("geo/", "geo/");
    catMap.put("pub/", "pub/");
}
...
while (iFilesInFolder.hasNext()) {
    ...
    out.println("<hr /><h4>Collected file <code>" + filePath + " (" + fileName + ")</code> plus " + (siblings.size() - 1) + " siblings</h4>");
